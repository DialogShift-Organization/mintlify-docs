...
<Steps>
  ...
  <Step title="Assign an organization">
    Select at least one client or project from the `Organizations` dropdown.

    <Warning>
      The assignment is mandatory. If you click `Invite` without selecting an organization, the error message *"Please select at least one client."* appears.
    </Warning>
  </Step>
