...
- The **channel code** for the source. Use `pwa-guestapp` for a generic guest app. If the surface is a booking engine, use `pwa-ibe`. The channel code lets us attribute conversations to the correct source.
...
| source    | no       | Channel code, e.g. `pwa-guestapp` or `pwa-ibe`.                                          |
