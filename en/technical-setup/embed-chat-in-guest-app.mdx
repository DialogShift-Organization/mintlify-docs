...
- The **Client ID** of your app. You find it in the [DialogShift dashboard](https://livechat.dialogshift.com/).
...
Replace `%id%` with your Client ID and set the channel code through `context.channel`.
...
```html
<iframe
  src="https://webchat.dialogshift.com?clid=%id%&source=pwa-guestapp&locale=en"
