...
The integration with HNS is configured via the integration page in the Live Chat App. You will need access credentials provided by the HNS Support Team.
...
After activation by HNS, the following fields must be filled in the DialogShift Live Chat App under **Settings** → **Integration**:

### Hotel Code

The hotel code for connecting with HNS. This is provided by HNS and uniquely identifies your hotel in the system.

### Username

The username for the HNS integration. Provided by the HNS Support Team.

### Password

The password for the HNS integration. Provided by the HNS Support Team.

<Warning>
  **Important:** All these credentials are provided by the HNS Support Team. When activating this integration, DialogShift can send the Client ID directly to HNS support, as HNS must register our Client ID in their system.
</Warning>
