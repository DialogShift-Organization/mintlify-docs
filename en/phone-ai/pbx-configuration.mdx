...
### Incompatible Phone Systems
  ...
  - Avaya IP Office: This phone system has only a very limited SIP implementation, which unfortunately is not compatible with Phone AI. However, it is possible to install an SBC proxy in front of the phone system to make it SIP-compatible.