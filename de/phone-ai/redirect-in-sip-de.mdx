...
- **Zu prüfende Einstellung:** Suche in den Trunk-Einstellungen nach Optionen wie:
  - Trust PAI / PAI vertrauen
  - Trust RPID/PAI
  - Vertrauenswürdige Identität / Trusted Identity
  - Connected Line ID / PAI annehmen
- **Aktion:** Aktiviere diese Einstellung für den SIP-Trunk von Dialog Shift.
...
- **Zu prüfende Einstellung:** Überprüfe die Regeln zur Anrufbehandlung oder Weiterleitung. Oft gibt es hier eine Auswahlmöglichkeit:
...
- **Aktion:** Stell sicher, dass die Regelung die Anzeige des ursprünglichen Anrufers vorsieht.
...
- **Zu prüfende Einstellung:** Suche nach Begriffen wie:
  - Passthrough Caller ID
  - Rufnummernübernahme bei Weiterleitung
  - Ursprungsrufnummer verwenden
- **Aktion:** Aktiviere diese Funktion, falls vorhanden.
...
- **Zu prüfende Einstellung:** Überprüfe die ausgehende Route, die für die Weiterleitung genutzt wird.
- **Aktion:** Stell sicher, dass das Feld für die "Outbound CallerID" auf dieser Route **leer** ist oder explizit so eingestellt ist, dass es die Rufnummer vom anrufenden Kanal übernimmt und keine feste Nummer erzwingt.
