...
- **Client-ID** deiner App. Du findest sie im [DialogShift-Dashboard](https://app.dialogshift.com). Zum Entwickeln und Testen kannst du die Demo-Client-ID `pro3107` verwenden.
...
Setze deine Client-ID als `id` und den Channel-Code über `context.channel`. Das Beispiel verwendet die Demo-Client-ID `pro3107`.
...
```html
<iframe
  src="https://webchat.dialogshift.com?clid=pro3107&source=pwa-guestapp&locale=de"
